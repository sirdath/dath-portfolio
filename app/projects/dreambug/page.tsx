...
export default function DreamBugPage() {
  return (
    <CaseStudyShell
      ...
      categoryText="Mobile · Generative art · Live app"
      extraNavActions={dreambugLiveAction}
    >
      ...
      <section className="aegis-section wrap" style={{ textAlign: "center" }}>
        ...
        <p className="aegis-lead" style={{ marginLeft: "auto", marginRight: "auto" }}>
          DreamBug is live at dreambug.app. The full write-up — the reader, the story gallery, and how the local art pipeline keeps a character consistent across a whole book — is still on its way. Here&apos;s a first page in the meantime.
        </p>
