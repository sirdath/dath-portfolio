...
export const projects: Project[] = [
  {
    ...
    slug: "nodebook",
    title: "Nodebook",
    subtitle: "On-demand knowledge compiler",
    description:
      "Submit a topic, link or question and Nodebook compiles a finished, cited book — chapters, diagrams, math — then wraps it in a spaced-recall loop so you actually remember it. Next.js 15 web + Expo mobile on Supabase, with a Gemini consensus engine.",
    techStack: [
      "Next.js 15",
      "React 19",
      "Expo / React Native",
    ...
    mediaUrl: "/redesign/nodebook/hero.webp",
    mediaType: "image",
    heroMediaUrl: "/redesign/nodebook/hero.webp",
    liveUrl: "https://node-book.app",
    featured: true,
    category: "ai",
    gridSpan: "large",
  },
  {
    ...
    slug: "dreambug",
    title: "DreamBug",
    subtitle: "Personalized children's storybooks",
    description:
      "A personalized children's storybook app. Parents pick a hero and DreamBug assembles illustrated, age-appropriate books on-demand with a coherent cast and world on every page — from a local, cost-free art pipeline (Ollama + SDXL, ComfyUI, VTracer) instead of a live paid image API. Expo + Supabase.",
    techStack: [
      "Expo",
      "React Native",
      "TypeScript",
  ...
  },
  {
    ...
    slug: "ds2-admin",
    title: "DS2 Workspace",
    subtitle: "Consultancy operating system + agentic copilot",
    description:
      "The private admin workspace for DS, a two-founder digital-solutions consultancy. An agentic copilot with model routing and a confirm-gate, six AI micro-engines, and a full pipeline / leads / content workspace on Next.js 15 + Supabase.",
    techStack: [
      "Next.js 15",
      "React 19",
      "TypeScript",
...
+-------------------------------------------------+`,
 ...
 +-------------------------------------------------------+`,
  ...
  },
  {
    ...
    githubUrl: "https://github.com/sirdath/geospatial-site-selection",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/sirdath/DS",
    featured: true,
    category: "geospatial",
    gridSpan: "tall",
    detailContent: {
  ...
  },
  {
    ...
    githubUrl: "https://github.com/sirdath/Portfolio-Dath",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/sirdath/mega-gym-website",
